...
function promote() {
  if (current_channel === "") {
    ...
    let userToPromote = window.prompt(
      "Please enter the username for the user that you want to promote."
    );
...
function remove() {
  if (current_channel === "") {
    ...
    let userToRemove = window.prompt(
      "Please enter the username for the user that you want to remove."
    );
